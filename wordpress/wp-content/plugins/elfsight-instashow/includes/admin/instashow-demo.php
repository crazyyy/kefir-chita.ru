            ...
            <div class="instashow-demo-accordion-item instashow-demo-accordion-item-active">
                ...
                <div class="instashow-demo-accordion-item-content">
                    ...
                    <div class="instashow-demo-filter-only instashow-demo-field-group">
                        ...
                        <div class="instashow-demo-field-group-description">
                            <?php _e('It allows to filter posts by @username, #hashtag or post URL.', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?>
                        </div>
                    ...
                    <div class="instashow-demo-filter-except instashow-demo-field-group">
                        ...
                        <div class="instashow-demo-field-group-description">
                            <?php _e('It allows to exclude specific posts by URL or posts which contain the specified hashtags or which refers to the certain authors.', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?>
                        </div>
                    ...
                    <div class="instashow-demo-field-group">
                        <div class="instashow-demo-field instashow-demo-lang">
                            ...
                            <select class="instashow-demo-select-language instashow-demo-select" name="lang">
                                ...
                                <option value="fi"><?php _e('Finnish', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></option>
                                ...
                                <option value="sl"><?php _e('Sloven&#x161;&#x10D;ina', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></option>
                                ...
                                <option value="vn"><?php _e('Vietnamese', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></option>
                            </select>
                        </div>
                    </div>
